...
// ─────────────────────────────────────────────────────────────────────────────
const CAMP_ID    = "shine";
const CAMP_LABEL = "Shine Squad";
const CAMP_EMOJI = "⭐";
const CAMP_COLOR = "#E8175D";   // hot pink · Shine Squad logo
const CAMP_DK    = "#A80F40";   // dark pink for text on light bg
const SK = {                     // storage keys — unique per camp
  campers: "sg-v1-campers",
  staff:   "sg-v1-staff",
  ce:      "sg-v1-ce",
  se:      "sg-v1-se",
  pin:     "sg-v1-pin",
...
// ── ACFC Palette ──────────────────────────────────────────────────────────────
const C = {
  bg:"#FDF5F8", surface:"#F5E8EF", card:"#FFFFFF", border:"#ECC0D2",
  shadow:"0 1px 4px rgba(100,0,50,0.09)",
  text:"#1B0812", sub:"#520E38", muted:"#A06080",
  navy:"#2D0840",
  green:"#2DA028", greenDk:"#1A6018",
  purple:"#7B1FA2", purpleDk:"#560D78",
  yellow:"#FFD700", yellowDk:"#7A6200",
  pink:"#E8175D",   pinkDk:"#A80F40",
  grey:"#C2C2C2",
...
const CSTATUS = {
  ...
  beforecare: { label:"Before Care", color:C.purpleDk,    dot:"◑" },
          ...
          <div>
            ...
            {activeStaff.length>0&&(
              <Card style={{padding:16,marginBottom:14}}>
                <div style={{fontWeight:700,fontSize:13,color:C.greenDk,marginBottom:10}}>👷 Staff On Site ({activeStaff.length})</div>
            ...
            {beforeList.length>0&&(
              <Card style={{padding:16,marginBottom:14}}>
                <div style={{fontWeight:700,fontSize:13,color:C.purpleDk,marginBottom:10}}>🌅 Before Care ({beforeList.length})</div>
                        ...
                        <div style={{display:"flex",alignItems:"flex-start",gap:12}}>
                          ...
                          <div style={{flex:1,minWidth:0}}>
                            ...
                            <div style={{display:"flex",gap:6,flexWrap:"wrap",marginBottom:6}}>
                              {c.beforecare&&<Badge color={C.purple} dk={C.purpleDk}>🌅 BC</Badge>}
